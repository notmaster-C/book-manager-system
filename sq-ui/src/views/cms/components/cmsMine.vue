        ...
        <el-row>
          ...
          <el-col :span="19">
            ...
            <i :class="this.user.sex != 1 ? 'el-icon-male' :'el-icon-female'"
               :style="this.user.sex != 1 ? 'color:bule' :'color:red'"></i>
              ...
              <el-col :span="16">
                <div>
                  ...
                  <div style="position: absolute;right: 10px;bottom:10px;">
                    <el-link type="danger" :underline="false" @click="unCollect(o.bookId)">
                      <i class="el-icon-position">移除</i>
                    </el-link>
                  </div>
...
import {listApplaud, listApplaudAndBookInfo} from "../../../api/applaud/applaud";
import {delCollect, listAndBookInfo} from "../../../api/collect/collect";
...
<style scoped>
.box-card {
  box-shadow: 0 0 20px 10px #e6ebf5;
}
