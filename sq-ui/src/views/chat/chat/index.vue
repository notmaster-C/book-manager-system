<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="接收方id" prop="fromId">
        <el-input
      ...
      <el-form-item label="聊天时间" prop="time">
    ...
    <el-table v-loading="loading" :data="chatList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="接收方id" align="center" prop="fromId" />
      <el-table-column label="聊天内容" align="center" prop="content" />
      <el-table-column label="聊天时间" align="center" prop="time" width="180">
...
<script>
import { listChat, getChat, delChat, addChat, updateChat, exportChat } from "@/api/chat/chat";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除用户聊天编号为"' + ids + '"的数据项?', "警告", {
