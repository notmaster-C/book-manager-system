 ...
 * @date 2022-03-22
 */
public class AsqBooks extends BaseEntity
{
    ...
    private AsqWriter writer;

    private AsqRankParm rankParm;

    public AsqRankParm getRankParm() {
        return rankParm;
    }

    public void setRankParm(AsqRankParm rankParm) {
        this.rankParm = rankParm;
    }

    public AsqWriter getWriter() {
        return writer;
    }

    public void setWriter(AsqWriter writer) {
        this.writer = writer;
    }
